...
const skillsData = [
    {
        ...
        link: "#",
        description: "A best Family car for long drives",
        aosDelay: "0",
    },
    {
        name: "Fast and Safe",
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4'>
            {
                skillsData.map((skill)=> (
                    <div key={skill.name} data-aos = "fade-up" data-aos-delay = {skill.aosDelay} className='card text-center group space-y-3 sm:space-y-6 p-4 sm:py-16 bg-dark hover:bg-primary duration-300 cursor-pointer text-white hover:text-black rounded-lg'>
